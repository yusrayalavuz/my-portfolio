...
export const projects = [
    {
        ...
        icon: '🛒',
        name: 'ECommerceAPI',
        desc: 'ASP.NET Core 8 ve Entity Framework Core ile geliştirilen RESTful e-ticaret backend API\'si. MS SQL Server, Code-First migration ve Swagger dokümantasyonu. Aktif geliştiriliyor.',
        tags: ['ASP.NET Core 8', 'Entity Framework', 'MS SQL Server'],
        github: 'https://github.com/yusrayalavuz/ECommerceAPI',
    },
    {
        id: 'lms',
        icon: '📚',
    ...
    },
    {
        ...
        desc: 'MS SQL Server üzerinden alınan verilerle Power BI ile uçtan uca analiz. Power Query veri temizliği, DAX modelleme ve dinamik KPI hesaplamaları ile mobil uyumlu raporlar.',
        tags: ['Power BI', 'DAX', 'MS SQL Server'],
